...
from src.stream import EMG_FLAG, HEADER, IMU_FLAG, PACKET_BYTES
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--seconds", type=int, default=5, help="Seconds to sample before reporting")
...
def main() -> None:
    ...
    print("[probe] Summary")
    print(f"  Frames: {stats['total']} total | {stats['emg']} EMG (AA) | {stats['imu']} IMU (BB) | {stats['other']} other")
